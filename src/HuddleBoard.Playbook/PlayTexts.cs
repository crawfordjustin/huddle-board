...
/// <summary>
/// What the tablet says to a seven-year-old, in spot language, for the original
/// fourteen. Call-strip labels use LEFT/RIGHT spot names; the exporter recolours
/// them to BLUE/ORANGE on the way out.
/// </summary>
public static partial class PlayTexts
{
    private static readonly IReadOnlyDictionary<int, PlayText> Original = new Dictionary<int, PlayText>
    {
        [1] = new(
            Calls:
            [
                new("BACK", "CARRY — straight ahead"),
                new("THROWER", "hand it off, don't watch"),
                new("EVERYONE ELSE", "GO"),
            ],
            Assign:
            [
                new("BACK",
                    "CARRY. Take one step toward the thrower, take the ball with both hands, and run straight past the snapper's right hip. North and south, not sideways."),
                new("THROWER",
                    "Catch the snap, turn immediately, and put the ball in the Back's belly with both hands. Do not watch him run."),
                new("SNAPPER",
                    "Snap it, then GO straight up the field. Stay out of the Back's running lane."),
                new("WIDE LEFT / SLOT RIGHT / WIDE RIGHT",
                    "GO. Sprint 9-10 yards downfield. You are not blocking — you are taking your defender away from the run."),
            ],
        ...
        [2] = new(
            Calls:
            [
                new("SLOT LEFT", "MOTION → CARRY right"),
            ...
            [
                new("SLOT LEFT",
                    "MOTION, then CARRY. Start running on the coach's signal. Be at FULL SPEED when you pass the thrower. Take the ball and keep running to the right sideline, then turn up."),
                new("THROWER",
                    "Catch the snap and hold the ball out at belly height. He takes it from you — do not throw it or push it at him."),
                new("WIDE RIGHT",
                    "GO. Sprint straight downfield and leave the sideline empty for him."),
        ...
        [3] = new(
            Calls:
            [
                new("SLOT RIGHT", "MOTION left → FAKE"),
                new("THROWER", "fake, count two, CARRY right"),
                new("EVERYONE ELSE", "GO"),
            ],
            Assign:
            [
                ...
                new("THROWER",
                    "Fake the handoff, count two, then step back to the right and CARRY. Patience first, speed second."),
                new("WIDE RIGHT",
                    "GO toward the sideline to clear the thrower's running lane."),
                new("WIDE LEFT / SLOT LEFT",
                    "GO. Sprint straight downfield 8 yards."),
                new("SNAPPER",
                    "Snap and GO up the middle, away from the thrower's path."),
            ],
        ...
        [4] = new(
            ...
            [
                new("BACK",
                    "CARRY. Start running toward the right sideline BEFORE you catch it. Catch it on the move, get to the edge, then turn up."),
                new("THROWER",
                    "Catch the snap and pitch it underhanded, out in front of him so he runs onto it. Soft toss, chest high."),
                new("WIDE RIGHT",
                    "GO straight for the sideline, then turn up. Take the corner with you and leave the edge empty."),
                new("TIGHT RIGHT",
                    "GO downfield at an angle toward the sideline."),
                new("WIDE LEFT / SNAPPER",
                    "GO. Sprint downfield on the backside."),
            ],
        ...
        [5] = new(
            Calls:
            [
                new("SLOT LEFT", "IN at 4"),
                new("SLOT RIGHT", "IN at 6"),
                new("BOTH WIDES", "SIT at 5"),
                new("SNAPPER", "SIT at 2"),
            ],
            Assign:
            [
                new("SLOT LEFT",
                    "IN at 4. Three hard steps upfield, then break inside at an angle. Look for the ball right away."),
                new("SLOT RIGHT",
                    "IN at 6. Same shape, but take FIVE steps first so you cross behind him. Never run at the same depth as the other slot."),
                new("WIDE LEFT / WIDE RIGHT",
                    "SIT at 5. Run 5 yards, stop, turn back to the thrower and show your hands."),
                new("THROWER",
                    "Pick your slant before the snap. Catch, one step, throw. Do not hold this ball."),
                new("SNAPPER",
                    "SIT at 2. Snap, release 2 yards straight up, turn around. You are the emergency dump-off."),
            ],
        ...
        [6] = new(
            Calls:
            [
                new("WIDE RIGHT", "SIT at 5"),
                new("SLOT RIGHT", "CORNER"),
                new("WIDE LEFT", "IN at 7"),
                new("BACK", "SWING left"),
            ],
            Assign:
            [
                new("WIDE RIGHT",
                    "SIT at 5. Run 5 yards, stop, come back one step toward the thrower. You are the easy completion."),
                new("SLOT RIGHT",
                    "CORNER. Sprint straight up 7 yards, then break out toward the corner of the field, over the top of him."),
                new("WIDE LEFT",
                    "IN at 7. Run 7 yards and break in across the middle."),
                new("BACK",
                    "SWING left. Loop out to the left flat as the safety valve."),
                new("THROWER",
                    "Watch the deep defender on the right. If he stays deep, throw the SIT. If he comes up, throw the CORNER over his head."),
            ],
        ...
        [7] = new(
            Calls:
            [
                new("SLOT LEFT", "OUT at 5"),
                new("TIGHT LEFT", "IN at 2, keep going"),
                new("WIDE LEFT", "GO"),
                new("WIDE RIGHT", "OUT at 6"),
            ],
            Assign:
            [
                new("SLOT LEFT",
                    "OUT at 5. Run 4-5 yards, plant, and break out toward the sideline. Show your hands the moment you turn."),
                new("TIGHT LEFT",
                    "IN at 2 and keep going. Cross the whole field about 2 yards deep and do not stop moving."),
                new("WIDE LEFT",
                    "GO. Release toward the sideline, then sprint deep. Run the deep defender off and stay outside."),
                new("WIDE RIGHT",
                    "OUT at 6. Your backside answer."),
                new("THROWER",
                    "Look at the OUT first. If the defender is sitting on it, throw the crosser underneath. Two answers, one look."),
                new("SNAPPER",
                    "SIT at 3."),
            ],
        ...
        [8] = new(
            Calls:
            [
                new("SNAPPER", "count 1-2, then GO"),
                new("BOTH WIDES", "GO deep"),
                new("TIGHT RIGHT", "OUT at 6"),
                new("BACK", "SWING left"),
            ],
            Assign:
            [
                new("SNAPPER",
                    "Snap the ball. Count 'one-thousand-one, one-thousand-two' standing still. THEN GO straight up the middle to 6 yards and turn around."),
                new("WIDE LEFT / WIDE RIGHT",
                    "GO. Sprint as deep as you can and take everybody with you."),
                new("TIGHT RIGHT",
                    "OUT at 6."),
                new("BACK",
                    "SWING left as the checkdown."),
                new("THROWER",
                    "Look deep for one count to hold the defense, then come back to the snapper. He will be alone."),
            ],
        ...
        [9] = new(
            Calls:
            [
                new("TIGHT LEFT", "OUT at 2"),
                new("SLOT LEFT", "OUT at 8"),
                new("WIDE LEFT", "CORNER"),
                new("WIDE RIGHT", "IN at 5"),
            ],
            Assign:
            [
                new("TIGHT LEFT",
                    "OUT at 2. Sprint to the left flat and get width fast. You are the shallow answer."),
                new("SLOT LEFT",
                    "OUT at 8. Run 8 yards straight up, then break out. You are the middle answer."),
                new("WIDE LEFT",
                    "CORNER. Release straight toward the sideline, then sprint up it. You are the shot — stay outside of everybody."),
                new("WIDE RIGHT",
                    "IN at 5. Work back across the middle as the backside checkdown."),
                new("THROWER",
                    "Count them off deep to short: CORNER, then OUT at 8, then OUT at 2. Take the first one open and get rid of it."),
            ],
        ...
        [10] = new(
            Calls:
            [
                new("BACK", "WHEEL up the right sideline"),
                new("WIDE RIGHT", "POST"),
                new("SLOT RIGHT", "IN at 6"),
                new("WIDE LEFT", "OUT at 6"),
            ],
            Assign:
            [
                new("BACK",
                    "WHEEL. Run out toward the sideline BEHIND the line of scrimmage. Get all the way wide, THEN turn straight up the sideline. Look back over your outside shoulder."),
                new("WIDE RIGHT",
                    "POST. Sprint 4 yards, then angle inside toward the middle. Stay inside — you are clearing the deep defender away from the wheel."),
                new("SLOT RIGHT",
                    "IN at 6. Second option."),
                new("WIDE LEFT",
                    "OUT at 6. Backside answer."),
                new("THROWER",
                    "Peek at the post to move the deep defender, then throw the wheel up the sideline. Lead him toward the sideline, never inside."),
            ],
        ...
        [11] = new(
            Calls:
            [
                new("THROWER", "fake the dive, count one"),
                new("BACK", "FAKE → SWING right"),
                new("WIDE LEFT", "CROSS deep"),
                new("WIDE RIGHT", "GO"),
                new("SLOT RIGHT", "IN at 3"),
            ],
            Assign:
            [
                new("THROWER",
                ...
                new("WIDE LEFT",
                    "CROSS. Three hard steps upfield, then cross the field on a climbing angle — you should be 12 yards deep by the far side."),
                new("WIDE RIGHT",
                    "GO. Sprint straight downfield and clear the deep middle out."),
                new("SLOT RIGHT",
                    "IN at 3. The safety valve if the deep cross is covered."),
            ],
        ...
        [12] = new(
            ...
            [
                new("BOTH WIDES", "GO deep"),
                new("SLOT LEFT", "SIT at 6"),
                new("SLOT RIGHT", "SIT at 4"),
                new("SNAPPER", "SIT at 2"),
            ],
            Assign:
            [
                new("WIDE LEFT / WIDE RIGHT",
                    "GO. Sprint straight downfield as fast as you can and clear out the deep defenders."),
                new("SLOT LEFT",
                    "SIT at 6. Run 6 yards, drift 2 yards toward the sideline, and sit down in the open space. Face the thrower."),
                new("SLOT RIGHT",
                    "SIT at 4. Run 4 yards, drift toward the sideline, and sit down. Face the thrower."),
                new("SNAPPER",
                    "SIT at 2. Snap, release 2 yards, turn around. You are the last resort — always available."),
                new("THROWER",
                    "Everybody is at a different depth on purpose. Scan 6, then 4, then 2. Somebody will be standing in grass."),
            ],
        ...
        [13] = new(
            Calls:
            [
                new("TIGHT RIGHT", "OUT at 2 — front pylon"),
                new("WIDE RIGHT", "CORNER — back pylon"),
                new("WIDE LEFT", "CORNER"),
                new("BACK", "SWING left"),
            ],
            Assign:
            [
                new("TIGHT RIGHT",
                    "OUT at 2. Run 2 yards and break flat to the front corner of the end zone. You are the quick, easy score."),
                new("WIDE RIGHT",
                    "CORNER. Sprint on an angle toward the back corner of the end zone. Look over your outside shoulder."),
                new("WIDE LEFT",
                    "CORNER on the backside — the answer if the defense overloads the right."),
                new("BACK",
                    "SWING left as the checkdown if nothing opens up."),
                new("THROWER",
                    "Front pylon first — if it is open it is a walk-in. If not, throw the back-corner fade high and outside where only he can get it."),
            ],
        ...
        [14] = new(
            Calls:
            [
                new("TIGHT LEFT", "OUT at 1"),
                new("SLOT LEFT", "OUT at 3"),
                new("WIDE LEFT", "OUT at 5"),
                new("WIDE RIGHT", "POST"),
                new("THROWER", "roll left"),
            ],
            Assign:
            [
                new("TIGHT LEFT",
                    "OUT at 1. The shallowest step of the staircase. Fastest, shortest answer."),
                new("SLOT LEFT",
                    "OUT at 3. Never drift down into the 1-yard route."),
                new("WIDE LEFT",
                    "OUT at 5. Release wide right away, get to 5, then break out. Stay on top of and outside of both of them."),
                new("WIDE RIGHT",
                    "POST across the middle — the shot if everyone chases the outs."),
                new("THROWER",
                    "Roll to the left. Three receivers break out in a staircase in front of you. Throw the highest open one, and get to the sideline if nobody is."),
            ],
